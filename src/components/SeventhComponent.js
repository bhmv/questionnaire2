    ...
    return (
      <div className='container'>
        <h1 className='text-center qHeadings mb-3'>
          {!this.props.filteredOut5.length < 1  ? <h1>Check out our venue recommendations <br /> that best fit your needs.</h1> : <h1>No matching results now <br/> let us contact you with the best fit for you.</h1> }
        </h1>
